...
public class Settings extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView3 = (TextView) findViewById(R.id.stnametext);
        textView4 = (TextView) findViewById(R.id.stowntext);
        textView5 = (TextView) findViewById(R.id.staddtext);
        textView6 = (TextView) findViewById(R.id.stcontext);
        textView7 = (TextView) findViewById(R.id.stemailtext);
        textView8 = (TextView) findViewById(R.id.stpantext);
        textView9 = (TextView) findViewById(R.id.stgstintext);
        textView10 = (TextView) findViewById(R.id.stinvtext);
        button=(Button)findViewById(R.id.savesettings);
        editText=(EditText)findViewById(R.id.stname);
        editText1=(EditText)findViewById(R.id.stown);
        editText2=(EditText)findViewById(R.id.stadd);
        editText3=(EditText)findViewById(R.id.stcon);
        editText4=(EditText)findViewById(R.id.stemail);
        editText5=(EditText)findViewById(R.id.stpan);
        editText6=(EditText)findViewById(R.id.stgstin);
        editText7=(EditText)findViewById(R.id.stinv);
...
//        reports.setTitle(mNewTitle11);
    ...
    public void saveSettings(View view) {
        if (!(editText.getText().toString().isEmpty())) {
            ...
            if (!(editText4.getText().toString().isEmpty())) {
                EditSettingsAPI editSettingsAPI = new EditSettingsAPI(this, this);
                editSettingsAPI.processEditSettings(editText.getText().toString(), editText1.getText().toString(), editText2.getText().toString(), editText3.getText().toString(), editText4.getText().toString(), editText5.getText().toString(), editText6.getText().toString(), editText7.getText().toString());
            }
            else {
    ...
    {
        SettingsAPI settingsAPI=new SettingsAPI(this,this);
        settingsAPI.processSettings();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            ...
            startActivity(i);
            Settings.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(Settings.this, ProductList.class);
            startActivity(i);
            Settings.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(Settings.this, Category.class);
            startActivity(i);
            Settings.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            Settings.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_SETTINGSINFO) == 0) {

JSONObject jsonObject=new JSONObject(data);
                editText.setText(jsonObject.getString("store_name"));
                editText1.setText(jsonObject.getString("store_owner"));
                editText2.setText(jsonObject.getString("store_address"));
                editText3.setText(jsonObject.getString("contact_number"));
                editText4.setText(jsonObject.getString("store_email"));
                editText5.setText(jsonObject.getString("pan_number"));
                editText6.setText(jsonObject.getString("store_gstin"));
                editText7.setText(jsonObject.getString("invoice_start"));

            }
            if (tag.compareTo(Config.TAG_EDIT_SETTINGSINFO) == 0) {
