...
import com.fingertip.catalog.adapter.UserGroupAdapter;
...
import com.fingertip.catalog.parsar.UserGroupParsar;
...
public class UserGroup  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    TextView textView;
    ...
    private List<UserGroupBO> userGroupBOList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_gr);
...
//        textView4.setTypeface(typeface);
        recyclerView=(RecyclerView)findViewById(R.id.user_group_list);
...
//        reports.setTitle(mNewTitle11);
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UserGroup.this, MyProfile.class);
    ...
    public void goToAddUserGroup(View view) {
        Intent intent=new Intent(this,AddUserGroup.class);
        startActivity(intent);
        UserGroup.this.overridePendingTransition(R.anim.righttoleft,
                R.anim.lefttoright);
    }
    @Override
    protected void onResume() {
        ...
        getUserGroup();
        try {
            EditUserGroup.acc_list.clear();
            EditUserGroup.mod_list.clear();
            EditUserGroup.access.clear();
            EditUserGroup.modify.clear();
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    {
        try {
            userGroupBOList = (List<UserGroupBO>)useMap.get("usergroup_list");
            Log.d("grr", useMap.toString());


            recyclerView.setHasFixedSize(true);
            recyclerView.setItemAnimator(new DefaultItemAnimator());

            userGroupAdapter= new UserGroupAdapter(this,UserGroup.this, userGroupBOList,this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            Intent i = new Intent(UserGroup.this, MainActivity.class);
            startActivity(i);
            UserGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(UserGroup.this, ProductList.class);
            startActivity(i);
            UserGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(UserGroup.this, Category.class);
            startActivity(i);
            UserGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            UserGroup.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_USER_GROUP_LIST) == 0) {
                ...
                useMap = UserGroupParsar.parseGroups(data);
                setGroupList();
