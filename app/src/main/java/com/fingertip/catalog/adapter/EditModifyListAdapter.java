...
public class EditModifyListAdapter  extends RecyclerView.Adapter<CheckdatacatHolder> implements CompoundButton.OnCheckedChangeListener{
    ...
    public EditModifyListAdapter(Activity activity, Context context, ArrayList itemList,List n) {
