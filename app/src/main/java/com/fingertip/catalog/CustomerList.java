...
import com.fingertip.catalog.adapter.CustomerAdapter;
import com.fingertip.catalog.api.CategoryListAPI;
import com.fingertip.catalog.api.CustomerListAPI;
...
public class CustomerList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1=(TextView)findViewById(R.id.cusnametext);
        textView2=(TextView)findViewById(R.id.cusemailtext);
        textView3=(TextView)findViewById(R.id.cususertext);
        textView4=(TextView)findViewById(R.id.cusmobiletext);
        textView5=(TextView)findViewById(R.id.cusstatustext);
...
textView.setTypeface(typeface1);
        ...
        recyclerView=(RecyclerView)findViewById(R.id.cuslist);
...
//        reports.setTitle(mNewTitle11);
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerList.this, MyProfile.class);
    ...
    protected void onResume() {
        ...
        getCustomerList();
        EditCusImageFargment.fileBody=null;
        EditCusImageFargment.selectedPath1=null;
    ...
    {
        try {
            customerBOList = (List<CustomerBO>)catMap.get("customer_list");
            ...
            customerAdapter= new CustomerAdapter(this,CustomerList.this, customerBOList,this);
    ...
    {
        CustomerListAPI customerListAPI=new CustomerListAPI(this,this);
        customerListAPI.processCustomersList();
    }
    public void gotoAddCus(View view) {
        Intent intent=new Intent(this,AddCustomer.class);
        startActivity(intent);
        CustomerList.this.overridePendingTransition(R.anim.righttoleft,
                R.anim.lefttoright);
    }
    @Override
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            Intent i = new Intent(CustomerList.this, MainActivity.class);
            startActivity(i);
            CustomerList.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(CustomerList.this, ProductList.class);
            startActivity(i);
            CustomerList.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(CustomerList.this, Category.class);
            startActivity(i);
            CustomerList.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            CustomerList.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_CUSTOMERS_LIST) == 0) {
                Log.d("datahoome", data);
                catMap = CustomerListParsar.parseCustomerList(data);
                setCustomerList();
