...
import com.fingertip.catalog.adapter.EdityCouponAdapter;
...
import com.fingertip.catalog.api.EditCouponAPI;
...
public class EditCoupon  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    Menu nav_Menu;
    ...
    public static EdityCouponAdapter edityCouponAdapter;
    public static List<String> coup_list = new ArrayList<String>();
    ...
    CheckBox checkBox1;
    public static ArrayList<String> cus_list = new ArrayList<String>();
...
//        fontChanger.replaceFonts((ViewGroup)this.findViewById(android.R.id.content));
        ...
        spinnerArrayAdapter2 = new ArrayAdapter<String>(getApplicationContext(), R.layout.spinner_textview1, statusarray); //selected item will look like a spinner set from XML
...
//        reports.setTitle(mNewTitle11);
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                stat = spinner2.getSelectedItem().toString();
                if (stat.equals("Active")) {
                    stat = "1";
                } else if (stat.equals("Deactive")) {
                    stat = "0";
                }
        ...
        checkBox1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    ...
                    edityCouponAdapter = new EdityCouponAdapter(EditCoupon.this, EditCoupon.this, customerGroupBOList, EditCoupon.this, coup_list, true);
                    edityCouponAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(edityCouponAdapter);
                    EdityCouponAdapter.editgroup_list.clear();
...
//                    }
                    ...
                    edityCouponAdapter = new EdityCouponAdapter(EditCoupon.this, EditCoupon.this, customerGroupBOList, EditCoupon.this, coup_list, false);
        ...
        try {
            s1 = getIntent().getExtras().getString("coup_id", null);
            s2 = getIntent().getExtras().getString("coup_name", null);
            s3 = getIntent().getExtras().getString("coup_code", null);
            s4 = getIntent().getExtras().getString("coup_type", null);
            s5 = getIntent().getExtras().getString("coup_group", null);
            s6 = getIntent().getExtras().getString("coup_dis", null);
            s7 = getIntent().getExtras().getString("coup_amt", null);
            s8 = getIntent().getExtras().getString("coup_start", null);
            s9 = getIntent().getExtras().getString("coup_end", null);
            s10 = getIntent().getExtras().getString("coup_use_coupon", null);
            s11 = getIntent().getExtras().getString("coup_use_cust", null);
            s12 = getIntent().getExtras().getString("coup_group_id", null);
            s13 = getIntent().getExtras().getString("status", null);
            editText.setText(s2);
            editText1.setText(s3);
            editText2.setText(s6);
            editText3.setText(s7);
            editText4.setText(s10);
            editText5.setText(s11);
        ...
        String str[] = textView2.getText().toString().split("-");
        final int day2 = Integer.parseInt(str[0]);
        final int month2 = Integer.parseInt(str[1]);
        final int year2 = Integer.parseInt(str[2]);
        System.out.println("datt" + day2 + month2 + year2);
        String str1[] = textView3.getText().toString().split("-");
        final int day1 = Integer.parseInt(str1[0]);
        final int month1 = Integer.parseInt(str1[1]);
        final int year1 = Integer.parseInt(str1[2]);
        System.out.println("datt" + day1 + month1 + year1);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hide4();
                new DatePickerDialog(EditCoupon.this, date4, myCalendar5
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hide4();
                new DatePickerDialog(EditCoupon.this, date5, myCalendar5
                        .get(Calendar.YEAR), myCalendar5.get(Calendar.MONTH),
...
//        }
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EditCoupon.this, MyProfile.class);
                startActivity(intent);

            }
        });
        coup_list = Arrays.asList(s12.split(","));
        System.out.println("coups" + coup_list.toString());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            Intent i = new Intent(EditCoupon.this, MainActivity.class);
            startActivity(i);
            EditCoupon.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCoupon.this, ProductList.class);
            startActivity(i);
            EditCoupon.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCoupon.this, Category.class);
            startActivity(i);
            EditCoupon.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            EditCoupon.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void editCoupon(View view) {
        checkedcontacts = new StringBuilder();
        StringBuilder builder = null;
        cus_list.clear();
        for (int i = 0; i < cusgroupid.size(); i++)

        {
            checkedcontacts.append(cusgroupid.toString());
            checkedcontacts.append(",");
            s14 = cusgroupid.get(i).toString();
            if ((edityCouponAdapter.mCheckStates.get(i) == true)) {



                Log.d("aca", s14);
                cus_list.add(s14);
                builder = new StringBuilder(cus_list.toString());

                Log.d("aca1", String.valueOf(builder));
            }
            else if((edityCouponAdapter.mCheckStates.get(i) == false))
            {
                cus_list.remove(s14);
                builder = new StringBuilder(cus_list.toString());
                                            ...
                                            if (!(editText4.getText().toString().isEmpty())) {
                                                if (!(editText5.getText().toString().isEmpty())) {
                                                    if (checkBox1.isChecked()) {
                                                        System.out.println("catt"+s1);
                                                        EditCouponAPI editCouponAPI = new EditCouponAPI(this, this);
                                                        editCouponAPI.processEditCoupon(s1,editText.getText().toString(), editText1.getText().toString(), type, "5", editText2.getText().toString(), editText3.getText().toString(), textView2.getText().toString(), textView3.getText().toString(), editText4.getText().toString(), editText5.getText().toString(),stat);


                                                    } else {
                                                        System.out.println("catt1"+s1);
                                                        EditCouponAPI editCouponAPI1 = new EditCouponAPI(this, this);
                                                        editCouponAPI1.processEditCoupon(s1,editText.getText().toString(), editText1.getText().toString(), type, String.valueOf(builder).replaceAll(" ",""), editText2.getText().toString(), editText3.getText().toString(), textView2.getText().toString(), textView3.getText().toString(), editText4.getText().toString(), editText5.getText().toString(),stat);
...
//
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_EDIT_COUPON_LIST) == 0) {
                Log.d("datahoome", data);
                JSONObject jsonObject=new JSONObject(data);
                if(jsonObject.getString("status").equals("Success"))
                {
                    Toast.makeText(getApplicationContext(),"Coupon updated succesfully",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(EditCoupon.this, CouponList.class);
                    startActivity(intent);
                    EditCoupon.this.overridePendingTransition(R.anim.left_in,
                            R.anim.right_out);
            ...
            if (tag.compareTo(Config.TAG_CUSTOMER_GROUP_LIST) == 0) {
                ...
                try {
                    ...
                    dataJsonArr = jsonObject.getJSONArray("customergroup_info");
    ...
    public void setCusgroupList()
    {
        try {
            ...
            edityCouponAdapter= new EdityCouponAdapter(this,this,customerGroupBOList,this,coup_list,false);
