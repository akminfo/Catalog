...
public class DeleteUserAPI extends BaseAPI {
    ...
    public DeleteUserAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processDelete(final String catid) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.DELETEUSERSURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_DELETE_USERLIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_DELETE_USERLIST,"Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_DELETE_USERLIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_DELETE_USERLIST);
    }
}
