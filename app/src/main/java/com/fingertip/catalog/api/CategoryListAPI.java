...
public class CategoryListAPI extends BaseAPI {
    ...
    int otp;
    String cus_id;
    public CategoryListAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processCategoryList() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.CATEGORYLISTURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_CATEGORY_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_CATEGORY_LIST,"Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_CATEGORY_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_CATEGORY_LIST);
    }
}
