...
public class EditCouponAPI  extends BaseAPI {
    ...
    public EditCouponAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processEditCoupon(final String id1,final String s1, final String s2, final String s3,final String s10, final String s4, final String s5, final String s6, final String s7,final String s8,final String s9,final String s11) {
        showProgressDialog();


        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.EDITCOUPONURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_EDIT_COUPON_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_EDIT_COUPON_LIST, "Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_EDIT_COUPON_LIST);
                hideProgressDialog();
            }
        }) {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Config.PARAM_CATEGORY_ID, id1);
                ...
                params.put(Config.PARAM_CATEGORY_STATUS, s11);
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_EDIT_COUPON_LIST);
    }
}
