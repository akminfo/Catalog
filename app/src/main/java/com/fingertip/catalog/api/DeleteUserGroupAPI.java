...
public class DeleteUserGroupAPI extends BaseAPI {
    ...
    public DeleteUserGroupAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processDelete(final String catid) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.DELETEUSERGROUPURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_DELETE_USER_GROUP_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_DELETE_USER_GROUP_LIST,"Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_DELETE_USER_GROUP_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_DELETE_USER_GROUP_LIST);
    }
}
