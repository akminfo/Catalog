...
public class DeleteProductAPI extends BaseAPI {
    ...
    public DeleteProductAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processDelete(final String catid) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.DELETEPRODUCTURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_DELETE_PRODUCTS_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mCallback.updateScreen("ERROR", Config.TAG_DELETE_PRODUCTS_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_DELETE_PRODUCTS_LIST);
    }
}
