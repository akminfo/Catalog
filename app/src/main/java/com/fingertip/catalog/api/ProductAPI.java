...
public class ProductAPI extends BaseAPI {
    ...
    int otp;
    String cus_id;
    public ProductAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processProductList() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.PRODUCTLISTURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_PRODUCT_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_PRODUCT_LIST,"Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_PRODUCT_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_PRODUCT_LIST);
    }
}
