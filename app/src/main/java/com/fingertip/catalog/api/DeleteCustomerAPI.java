...
public class DeleteCustomerAPI extends BaseAPI {
    ...
    public DeleteCustomerAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processDelete(final String catid) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.DELETECUSTOMERURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_DELETE__CUSTOMER_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(Config.TAG_DELETE__CUSTOMER_LIST,"Error: " + error.getMessage());
                error.printStackTrace();
                mCallback.updateScreen("ERROR", Config.TAG_DELETE__CUSTOMER_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_DELETE__CUSTOMER_LIST);
    }
}
