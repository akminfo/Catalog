...
public class DeleteCategoryAPI extends BaseAPI {
    ...
    public DeleteCategoryAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processDelete(final String catid) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.DELETECATEGORYURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_DELETE_CATEGORY_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mCallback.updateScreen("ERROR", Config.TAG_DELETE_CATEGORY_LIST);
                hideProgressDialog();
            }
        }) {
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_DELETE_CATEGORY_LIST);
    }
}
