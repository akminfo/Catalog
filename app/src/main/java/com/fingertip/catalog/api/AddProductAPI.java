...
/**
 * Created by lenevo on 15-05-2018.
 */

public class AddProductAPI extends BaseAPI {
    ...
    public AddProductAPI(Context context, NetworkCallback callback) {
        super(context);
    ...
    public void processAddCategory(final String catname, final String catdesc, final String metatitle, final String metadesc, final String metakey, final String sort, final String top, final String status) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.ADDPRODUCTURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    hideProgressDialog();
//
                    mCallback.updateScreen(response, Config.TAG_ADD_PRODUCT_LIST);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                mCallback.updateScreen("ERROR", Config.TAG_ADD_PRODUCT_LIST);
                hideProgressDialog();
            }
        }) {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Config.PARAM_KEY_FEATURES, catdesc);
                ...
                params.put(Config.PARAM_SKU, metakey);
                params.put(Config.PARAM_CATEGORY_CHECKBOX, metakey);
                ...
                params.put(Config.PARAM_FEATURED_IMAGE, status);
                params.put(Config.PARAM_PRODUCT_IMAGE1, status);
                params.put(Config.PARAM_PRODUCT_IMAGE1, status);
                params.put(Config.PARAM_PRODUCT_SORT1, metakey);
        ...
        ctrl.addToRequestQueue(strReq, Config.TAG_ADD_PRODUCT_LIST);
    }
}
