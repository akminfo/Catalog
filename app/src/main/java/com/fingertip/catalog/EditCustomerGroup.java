...
import com.fingertip.catalog.api.EditCustomerGroupAPI;
...
public class EditCustomerGroup extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    Menu nav_Menu;
    Spinner spinner1;
...
s1=getIntent().getExtras().getString("id",null);
            ...
            s3=getIntent().getExtras().getString("status",null);
        ...
        spinner1 = (Spinner) findViewById(R.id.enablegroup);
        ...
        editText = (EditText) findViewById(R.id.grouptext);

        textView4 = (TextView) findViewById(R.id.toolbar_title);

        textView = (TextView) findViewById(R.id.groupgeneral);
...
//        reports.setTitle(mNewTitle11);
        ...
        if(s3.equals("1"))
        {
            typearray.add("Active");
            typearray.add("Inactive");
            type = "1";
        }
        else {
            typearray.add("Inactive");
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EditCustomerGroup.this, MyProfile.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            Intent i = new Intent(EditCustomerGroup.this, MainActivity.class);
            startActivity(i);
            EditCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCustomerGroup.this, ProductList.class);
            startActivity(i);
            EditCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCustomerGroup.this, Category.class);
            startActivity(i);
            EditCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            EditCustomerGroup.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void editCusGroup(View view) {
        if(!(editText.getText().toString().isEmpty()))
        {

                EditCustomerGroupAPI editCustomerGroup=new EditCustomerGroupAPI(this,this);
            editCustomerGroup.processEditCusGroup(s1,editText.getText().toString(),type,saveduser);
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_EDIT_GROUP_LIST) == 0) {
                ...
                if(jsonObject.getString("status").equals("Success"))
                {
                    ...
                    Intent intent = new Intent(EditCustomerGroup.this, CustomerGroup.class);
                    startActivity(intent);
                    EditCustomerGroup.this.overridePendingTransition(R.anim.left_in,
                            R.anim.right_out);
                }
