...
public class AddCustomer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=(Button)findViewById(R.id.savecusdata3);
...
//        reports.setTitle(mNewTitle11);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddCustomer.this, MyProfile.class);
...
{
    if(!(CustomerGeneralFragment.editText.getText().toString().isEmpty())) {
        if (!(CustomerGeneralFragment.editText1.getText().toString().isEmpty())) {
            if (!(CustomerGeneralFragment.cusg.equals("Choose Customer Group"))) {
            if (!(CustomerGeneralFragment.editText2.getText().toString().isEmpty())) {
                if (!(CustomerGeneralFragment.editText3.getText().toString().isEmpty())) {
                    if (!(CustomerGeneralFragment.editText4.getText().toString().isEmpty())) {
                        if (!(CustomerGeneralFragment.editText5.getText().toString().isEmpty())) {
                            if (!(CustomerGeneralFragment.title.equals("Status"))) {
                                if (!(CustomerDataFragment.editText.getText().toString().isEmpty())) {
                                    if (!(CustomerDataFragment.editText1.getText().toString().isEmpty())) {
                                        if (!(CustomerDataFragment.editText2.getText().toString().isEmpty())) {
                                            if (!(CustomerDataFragment.editText3.getText().toString().isEmpty())) {
                                                if (!(CustomerDataFragment.editText4.getText().toString().isEmpty())) {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new CustomerGeneralFragment(), "General");
        adapter.addFrag(new CustomerDataFragment(), "Data");
        adapter.addFrag(new ProFragment(), "Image");
...
//        viewPager.setCurrentItem(1);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            ...
            startActivity(i);
            AddCustomer.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            ...
            Intent i = new Intent(AddCustomer.this, ProductList.class);
            startActivity(i);
            AddCustomer.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(AddCustomer.this, Category.class);
            startActivity(i);
            AddCustomer.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            AddCustomer.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    private void doFileUpload() {
        ...
        String urlString = "http://fingertipmail.com/catalog_store2508/admin/rest/api/Customer/add";
        try {
            ...
            reqEntity.addPart(Config.PARAM_FIRST_NAME, new StringBody(CustomerGeneralFragment.editText.getText().toString()));
            reqEntity.addPart(Config.PARAM_LAST_NAME, new StringBody(CustomerGeneralFragment.editText1.getText().toString()));
            reqEntity.addPart(Config.PARAM_CUSTOMER_GROUP, new StringBody(CustomerGeneralFragment.cusid));
            reqEntity.addPart(Config.PARAM_EMAIL, new StringBody(CustomerGeneralFragment.editText2.getText().toString()));
            reqEntity.addPart(Config.PARAM_USER_PASS, new StringBody(CustomerGeneralFragment.editText3.getText().toString()));
            reqEntity.addPart(Config.PARAM_USER_NAME, new StringBody(CustomerGeneralFragment.editText4.getText().toString()));
            reqEntity.addPart(Config.PARAM_MOBILE, new StringBody(CustomerGeneralFragment.editText5.getText().toString()));
            reqEntity.addPart(Config.PARAM_GENDER, new StringBody(CustomerGeneralFragment.gen));
            //reqEntity.addPart(Config.PARAM_IMAGE, new StringBody(EditProDataFragment.editText1.getText().toString()));
            System.out.println("ADDRESSS"+CustomerGeneralFragment.editText2.getText().toString()+CustomerDataFragment.editText1.getText().toString()+CustomerDataFragment.editText2.getText().toString()+CustomerDataFragment.editText3.getText().toString()+CustomerDataFragment.editText4.getText().toString());
            reqEntity.addPart(Config.PARAM_CATEGORY_STATUS, new StringBody(CustomerGeneralFragment.flag));
            reqEntity.addPart(Config.PARAM_ADDRESS, new StringBody(CustomerDataFragment.editText.getText().toString()));
            reqEntity.addPart(Config.PARAM_CITY, new StringBody(CustomerDataFragment.editText1.getText().toString()));
            reqEntity.addPart(Config.PARAM_PINCODE, new StringBody(CustomerDataFragment.editText2.getText().toString()));
            reqEntity.addPart(Config.PARAM_COUNTRY_ID, new StringBody(CustomerDataFragment.editText3.getText().toString()));
            reqEntity.addPart(Config.PARAM_ZONE_ID, new StringBody(CustomerDataFragment.editText4.getText().toString()));


     if(ProFragment.fileBody!=null)
     {
         reqEntity.addPart(Config.PARAM_IMAGE, ProFragment.fileBody);
     }
     else if(ProFragment.selectedPath1!=null)
     {
         File file1 = new File(ProFragment.selectedPath1);
