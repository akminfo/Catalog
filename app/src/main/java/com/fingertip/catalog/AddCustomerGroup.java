...
public class AddCustomerGroup extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    Menu nav_Menu;
    Spinner spinner1;
...
//        reports.setTitle(mNewTitle11);
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddCustomerGroup.this, MyProfile.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            Intent i = new Intent(AddCustomerGroup.this, MainActivity.class);
            startActivity(i);
            AddCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(AddCustomerGroup.this, ProductList.class);
            startActivity(i);
            AddCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(AddCustomerGroup.this, Category.class);
            startActivity(i);
            AddCustomerGroup.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            AddCustomerGroup.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void addCusGroup(View view) {
        if(!(editText.getText().toString().isEmpty()))
        {
            if(!(type.equals("Status")))
            {
                AddCustomerGroupAPI addCustomerGroupAPI=new AddCustomerGroupAPI(this,this);
                addCustomerGroupAPI.processAddCusGroup(editText.getText().toString(),type,saveduser);
            }
            else {
                Toast.makeText(getApplicationContext(),"Please choosen status",Toast.LENGTH_SHORT).show();
            }
        }
        else {
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_ADD_GROUP_LIST) == 0) {
                ...
                if(jsonObject.getString("status").equals("Success"))
                {
                    ...
                    Intent intent = new Intent(AddCustomerGroup.this, CustomerGroup.class);
                    startActivity(intent);
                    AddCustomerGroup.this.overridePendingTransition(R.anim.left_in,
                            R.anim.right_out);
                }
