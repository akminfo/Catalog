...
public class EditCategory extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    TextView textView;
...
//        reports.setTitle(mNewTitle11);
        ...
        try
        {
            s1=getIntent().getExtras().getString("cat_id");
            s2=getIntent().getExtras().getString("cat_name");
            s3=getIntent().getExtras().getString("cat_sort");
            s4=getIntent().getExtras().getString("cat_desc");
            s5=getIntent().getExtras().getString("meta_title");
            s6=getIntent().getExtras().getString("meta_desc");
            s7=getIntent().getExtras().getString("meta_key");
            s8=getIntent().getExtras().getString("top");
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EditCategory.this, MyProfile.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        bundle.putString("catid",s1);
        final ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new GeneralCatFragment(),"General");
        adapter.addFrag(new DataFragment1(),"Data");
...
//        viewPager.setCurrentItem(1);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            ...
            startActivity(i);
            EditCategory.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCategory.this, ProductList.class);
            startActivity(i);
            EditCategory.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(EditCategory.this, Category.class);
            startActivity(i);
            EditCategory.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            EditCategory.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
