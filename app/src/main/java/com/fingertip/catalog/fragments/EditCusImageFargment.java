...
public class EditCusImageFargment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.edit_cusimage, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        UrlImageViewHelper.setUrlDrawable(imageView1,  Config.IMAGEURL+ EditCustomer.s15);
