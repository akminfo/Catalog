...
public class ProductListParsar {
    public static Map parseProducts(String response){
    ArrayList<String> cat_list1 = new ArrayList<String>();
        ...
        if(response.length()>0){
            ...
            try{
                ...
                if (mainJsonObject != null){
                    JSONArray mainJsonArray = mainJsonObject.getJSONArray("product_info");
...
//
                                ...
                                if (!jsonObject.isNull("description")) {
                                    productBO.setDesc(String.valueOf(Html.fromHtml(jsonObject.getString("description"))).replaceAll("(\r\n|\n)", "<br/>"));
                                } else {
                                    productBO.setDesc("");
                                }
                                ...
                                if (!jsonObject.isNull("meta_description")) {
                                    productBO.setMeta_desc(String.valueOf(Html.fromHtml(jsonObject.getString("meta_description"))).replaceAll("(\r\n|\n)", "<br/>"));
                                } else {
                                ...
                                if (!jsonObject.isNull("key_feature")) {
                                    productBO.setKeyfeat(String.valueOf(Html.fromHtml(jsonObject.getString("key_feature"))).replaceAll("(\r\n|\n)", "<br/>"));
                                } else {
                    ...
                    proMap.put("product_list",productBOList);
                }
            }catch (Exception e){
                e.printStackTrace();
            }
