...
import com.fingertip.catalog.adapter.UsersAdapter;
import com.fingertip.catalog.api.CustomerGroupAPI;
import com.fingertip.catalog.api.UsersAPI;
...
import com.fingertip.catalog.parsar.UsersParsar;
...
public class UsersList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    TextView textView;
    ...
    private List<UsersBO> usersBOList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_useradmin_list);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);

        setSupportActionBar(toolbar);
        setTitle("");
        textView=(TextView)findViewById(R.id.toolbar_title);
        textView1=(TextView)findViewById(R.id.useadmintext);
        textView2=(TextView)findViewById(R.id.useadminstatus);
        textView3=(TextView)findViewById(R.id.useadminactions);
...
//        reports.setTitle(mNewTitle11);
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UsersList.this, MyProfile.class);
    ...
    public void goToAddUser(View view) {
        ...
        startActivity(intent);
        UsersList.this.overridePendingTransition(R.anim.righttoleft,
                R.anim.lefttoright);
    }
    @Override
    ...
    {
        try {
            usersBOList = (List<UsersBO>)useMap.get("user_list");
            ...
            usersAdapter= new UsersAdapter(this,UsersList.this, usersBOList,this);
    ...
    {
        UsersAPI usersAPI=new UsersAPI(this,this);
        usersAPI.processUsersList();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            ...
            Intent i = new Intent(UsersList.this, ProductList.class);
            startActivity(i);
            UsersList.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
            ...
            Intent i = new Intent(UsersList.this, Category.class);
            startActivity(i);
            UsersList.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            UsersList.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
...
//        }
    ...
    public void updateScreen(String data, String tag) {
        try {
            if (tag.compareTo(Config.TAG_USERS_LIST) == 0) {
                Log.d("datahoome", data);
                useMap = UsersParsar.parseUsers(data);
                setUsersList();
