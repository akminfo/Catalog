...
public class Category extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkCallback {
    TextView textView;
...
public void goToAdd(View view) {
    ...
    startActivity(intent);
    Category.this.overridePendingTransition(R.anim.righttoleft,
            R.anim.lefttoright);
}
    @Override
    ...
    public void setCategoryList()
    {
        try {
            ...
            categoryListAdapter= new CategoryListAdapter(this,Category.this, categoryBOList,this);
...
{
    CategoryListAPI categoryListAPI=new CategoryListAPI(this,this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.dash) {
            ...
            Intent i = new Intent(Category.this, ProductList.class);
            startActivity(i);
            Category.this.overridePendingTransition(R.anim.righttoleft,
                    R.anim.lefttoright);
            drawer.closeDrawer(GravityCompat.START);
...
//            drawer.closeDrawer(GravityCompat.START);
            ...
            startActivity(intent);
            Category.this.overridePendingTransition(R.anim.left_in,
                    R.anim.right_out);
            drawer.closeDrawer(GravityCompat.START);
        }
